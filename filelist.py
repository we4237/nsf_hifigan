...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output', type=str, default="./filelists/24k_audio_filelist.txt", help='File list output path')
    parser.add_argument('-s', '--sr', type=int, default=24000, help='File target sample rate')
